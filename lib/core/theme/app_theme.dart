  ...
  static ThemeData light() {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headlineMedium: AppTextStyles.ui(
          size: 22,
          weight: FontWeight.w600,
          color: AppColors.text,
        ),
        headlineSmall: AppTextStyles.ui(
          size: 18,
          weight: FontWeight.w600,
          color: AppColors.text,
        ),
        titleMedium: AppTextStyles.ui(
          size: 16,
          weight: FontWeight.w500,
          color: AppColors.text,
        ),
        titleSmall: AppTextStyles.ui(
          size: 14,
          weight: FontWeight.w500,
          color: AppColors.text,
        ),
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: AppTextStyles.ui(
          size: 16,
          weight: FontWeight.w600,
          color: AppColors.text,
        ),
