...
class ChordFlashcardRangeSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final notifier = ref.read(chordFlashcardSettingsProvider.notifier);
    ...
    return Column(
      ...
      children: [
        ...
        UiText(
          'choisis la fondamentale la plus grave et la plus aiguë',
          size: 12,
          color: colors.text2,
        ),
