  ...
  group('Exercice Défilement - clé de Sol, 10 notes', () {
    testWidgets(
      ...
      (tester) async {
        ...
        //assert - retour sur la page de réglages Défilement, récap disparu
        expect(find.text('Lancer'), findsOneWidget);
        expect(find.text('Lecture · défilement'), findsNothing);
      },
    );
...
Future<void> _startDefilementExerciseWithTenNotes(WidgetTester tester) async {
  ...
  await tester.tap(
    find.descendant(
      of: find.byType(DefilementNoteCountRow),
